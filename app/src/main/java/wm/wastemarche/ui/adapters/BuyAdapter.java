...
import wm.wastemarche.ui.activities.main.BuyDetailsFragment;
import wm.wastemarche.ui.activities.main.MainActivity;

public class BuyAdapter extends BaseAdapter implements ImageLoaderProtocol {
    private final Context context;
    public List<Item> items;
    private final ImageLoader imageLoader;

    public BuyAdapter(final Context context) {
